...
La autenticación y cotización externas se validaron el 2026-09-07 con una cuenta autorizada y datos ficticios: login HTTP 200 y cotización HTTP 200. La cuenta devolvió cuatro transportadoras utilizables y rechazó Interrapidísimo porque no tiene código asociado. La prueba controlada avanzó hasta confirmación y reserva, pero el endpoint oficial de preenvíos respondió HTTP 503 y el portal mostró cero preenvíos. La creación y descarga del PDF real siguen pendientes de que el proveedor restablezca el servicio; el recorrido completo pasa contra un proveedor controlado y PostgreSQL real.
