...
describe('PostgresDashboardRepository', () => {
  ...
  beforeEach(async () => {
    ...
    try {
      await sql`TRUNCATE TABLE shipping_guide_jobs, shipping_quotes, order_confirmations, order_summaries, reservation_movements, order_status_events, sales_orders, whatsapp_conversations, catalog_stock, catalog_references CASCADE`;
